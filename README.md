...
| `Split Person` | Text list | One or many people separated by comma, semicolon, compact dot format (`person1.person2`), or new line | Optional (defaults to `me`) | Transaction |
