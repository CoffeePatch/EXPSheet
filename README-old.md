...
> Legacy snapshot only. The current documentation lives in [README.md](./README.md) and the workflow docs under `scripts/`.
> This file is kept as a reference for the older Google Forms-oriented layout.
